...
description: The POS Locator is a dedicated microfrontend application designed to help customers quickly find the nearest Home Credit service points and partner outlets across Indonesia. It provides an intuitive map-based experience, enabling users to search by city, region, or specific keywords.
...
- **Tools**: Git, Docker, K8S, GitLab, Jira
