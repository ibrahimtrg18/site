...
export const assets = {
  images: [
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/chat-data-patient.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/chat-history-patient.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/chat-reference-patient.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/chat-template-create-template.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/chat-template.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/chat.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/help.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/home.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/login.png" },
    { url: "/projects/assets/prixaai-teleconsultation-doctor/1.0.0/report.png" },
  ]
}
